					...
					[
						...
						},
						{
							...
							submenu: {
								...
								itemdata: [
									...
									{ text: "<spring:message code='menu.export_my_data'/>", onclick: { fn: exportMyData } },
									/*
						...
						},
						{
							...
							submenu: {
								id: "import",
								itemdata: [
									{ text: "<spring:message code='message.import.zipmaps'/>", onclick: { fn: importZipMap } },
						...
						{
							text: "<spring:message code='menu.remixActions'/>", onclick: { fn: remixActions }
						}
					]
				]
			}
		...
		},
		{
			...
			submenu: {
				...
				itemdata: [[{
					...
					text: "<spring:message code='menu.help.hotKey'/>",
					onclick: {
						fn: openHotKeys
					},
					disabled: false

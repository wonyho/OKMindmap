...
JinoControllerGuest.prototype.blurAll = function(){
...
JinoControllerGuest.prototype.findNodeAction = function(founds, unfold){
...
JinoControllerGuest.prototype.executeFindNodeAction = function(founds, unfold){
...
JinoControllerGuest.prototype.nextFindNodeAction = function(){
...
JinoControllerGuest.prototype.prevFindNodeAction = function(){
	var foundNodes = jMap.foundNodes;
	if(foundNodes.length == 0) return;
	jMap.findIndex--;
	if(jMap.findIndex < 0) {
...
//JinoControllerGuest.prototype.executeFindNodeAction = function(frm){
//	jMap.findForm = $(frm);
//
//	var searchText = jMap.findForm.find('#jino_input_search_text').val();
//	if(searchText != '') {
//		jMap.foundNodes = jMap.findNode(searchText, false, true, jMap.getSelecteds().getLastElement());
//		jMap.findIndex = 0;
//
//		jMap.findForm.find('#jino_form_search_results').removeClass('d-none');
//
//		if(jMap.foundNodes.length == 0) {
//			jMap.findForm.find('#jino_form_search_results').html('0/0');
//		} else {
//			jMap.findForm.find('#jino_form_search_action').addClass('d-none');
//			jMap.findForm.find('#jino_form_search_prev').removeClass('d-none');
//			jMap.findForm.find('#jino_form_search_next').removeClass('d-none');
//			jMap.findIndex = -1;
//			jMap.controller.nextFindNodeAction();
//		}
//	}
...
JinoControllerGuest.prototype.screenFocusAction = function(node){
	if(!node) node = jMap.getSelecteds().getLastElement();
...
//	var findIndex = jMap.findIndex; 
//
//	var node = jMap.foundNodes[findIndex].node;
//	
//	var currentNode = node;
...
//	
//	if(jMap.findForm) {
//		jMap.findForm.find('#jino_form_search_results').html( (jMap.findIndex+1) + '/' + jMap.foundNodes.length);
//	}
//
//	screenFocusAction(node);
//}

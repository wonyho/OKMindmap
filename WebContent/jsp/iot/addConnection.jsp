...
<head>
    ...
    <script type="text/javascript">
		var addDevice = function(){
			...
			$.ajax({
			      type: 'POST',
			      url: '${pageContext.request.contextPath}/iot/addconn.do?id=${data.board}',
			      data: {name : $("#name").val(), type: $("#mains").val(),note: $("#note").val(), board: ${data.board},layout : layout, layoutW: layoutW, layoutH: layoutH,  confirm : 1},
...
<body>
    <div class="container-fluid py-1">
        ...
        <div class="form-group">
            ...
            <select class="custom-select col" id="mains">
					<option groupid="0" value="0" selected>---Select---</option>
				<c:forEach var="main" items="${data.sensors }">
					<option groupid="${main.getGroupId()}" value="${main.getId()}">${main.getName()}</option>
				</c:forEach>
			</select>
        </div>
        <div class="form-group">
            ...
            <input type="text" required class="form-control" id="note">
        </div>
        
        <div id="groupid-1" class="groupid d-none">
        ...
        <div id="groupid-2" class="groupid d-none">
        	<div class="form-group">
	...
	<div class="text-center mt-4">
        	<button type="button" onclick="addDevice()" class="btn btn-primary">
			    Save
			</button>

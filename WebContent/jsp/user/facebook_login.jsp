				...
				<div class="form">
					<form id="frm-user-new" action="${pageContext.request.contextPath}/user/new.do" method="post" onSubmit="return checkSubmit(this);">
						...
						<div class="signup_btn">
							<input type="submit" class="create_btn" value="<spring:message code='button.confirm'/>" />
							<input type="button" class="create_btn" value="<spring:message code='button.cancel'/>" onclick="cancel();" />
						</div>
					</form>
				</div>
				    </div>

...
<body class="bg-gray-200 p-3">
	<div class="d-flex justify-content-center align-items-center vh-100">
		<div class="text-center py-5 px-3 bg-white shadow-lg rounded-lg w-100" style="min-height: 200px; max-width: 600px;">
			<img src="${pageContext.request.contextPath}/plugin/slideshow/check.png" width="80px;" class="mb-5">
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			if (message != '') {
				...
				$("h2.v1").html('<spring:message code="user.new.email_confirmed" />');
			}
			...
			var t = 3;
			setInterval(function(){ $("#toMain_btn").html('<spring:message code="error.gomain"/> (' + t-- +')'); }, 1000);
			setTimeout(function(){ window.location.href = '${pageContext.request.contextPath}/'; }, 3000);

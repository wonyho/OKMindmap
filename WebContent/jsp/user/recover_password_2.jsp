...
<body>
	...
	<div class="container-fluid py-3" style="max-width: 500px;">
		<img class="d-block mx-auto mb-3" src="${pageContext.request.contextPath}/theme/dist/images/icons/checked.svg" width="80px">
		...
		<div class="text-center mt-4">
			<a href="${pageContext.request.contextPath}/user/login.do" class="btn btn-dark btn-min-w">

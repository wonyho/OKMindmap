...
<head>
    ...
    <script type="text/javascript">
        ...
        function onRemixMap(data, textStatus, jqXHR) {
            if(data.status != 'ok') {
                alert(data.message);
                loading = false;
        ...
        function remixMap() {
            ...
            if (title != "") {
                ...
                var params = {
                    "title": title,
                    "remixMap": parent.jMap.cfg.mapId,
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    async: false,
                    url: '${pageContext.request.contextPath}/mindmap/remixmap.do',
                    data: params,
                    success: onRemixMap,
        ...
        $(document).ready(function () {
            ...
            $('#remixmap_title').val(parent.jMap.cfg.mapName);
            $('#remixmap_title').select();
        ...
        <div class="mx-auto" style="max-width: 300px;">
            <form id="frm_confirm">
                <div class="form-group">
                    ...
                    <input type="text" autofocus required class="form-control" id="remixmap_title">
                </div>

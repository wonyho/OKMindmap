...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			if(window.dwr) dwr.engine.setNotifyServerOnPageUnload(true, false);
		...
		<div class="treeview_left">
			<div class="treeview_bg">
				<ul id="admintree" class="admintree">
					...
					<li><a class="folder">Service plan</a>
						<ul>
							<li><a class="item" href="${pageContext.request.contextPath}/mindmap/admin/pricing/tier/list.do" target="adminContent">Plan management</a></li>
							<li><a class="item" href="${pageContext.request.contextPath}/mindmap/admin/pricing/tier/accounts.do" target="adminContent">Account list</a></li>
						</ul>
					</li>

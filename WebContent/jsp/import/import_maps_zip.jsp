...
<head>
	...
	<script type="text/javascript">
		var FILEUPLOAD_API_URL = "${pageContext.request.contextPath}/mindmap/importZipMaps.do";
	...
	<div class="container-fluid p-3">
		<div class="py-4 text-center">
			<div id="fileupload" class="mx-auto fileupload-thumbnail position-relative d-inline-block">
				...
				<input id="fileupload_input" type="file" accept=".zip" class="position-absolute top-0 left-0 w-100 h-100" />
			</div>
			<p class="font-italic">
				<spring:message code='message.import.zipmaps.default' />
			</p>
		</div>

...
<div class="container my-4">
	<%-- <h4 class="text-secondary"><span class="badge badge-secondary">I</span> What is it?</h4>
	<p>OKMindmap IoT is a service of Tubestory provider, it allows Tubestory's users connect IoT devices to their maps. User can do many actions 
	with IoT connection, such as:</p>
	<p class="ml-5">- Update sensor's result to server and synchronous to IoT nodes of OKMindmap</p>
	<p class="ml-5">- Remote control IoT devices by IoT nodes of OKMindmap</p>
	
	<h4 class="text-secondary"><span class="badge badge-secondary">II</span> How does it work?</h4>
	<p>It use HTTP request to post or get values from servers. Use POST method to send request and get response when we need to update result 
	or get action. So, we have to Ethernet or Wifi modules to allow IoT devices can access Internet. </p>
	<p>Each a interval time (user set this value 
	in IoT device), device will synchronous with server, then we can work with IoT device over OKMindmap</p>
	<img style="max-width: 100%;" alt="" src="${pageContext.request.contextPath}/doc/img/img1.png">
	
	<h4 class="text-secondary"><span class="badge badge-secondary">III</span> How to use?</h4>
	<p><b>API_CODE</b> returned like: <b>{"iot_device_key":"1-ee1f9ccf0f42dba12f94bed0d09160d7","iot_server":"http://tubestory.co.kr/iot/"}</b></p>

	<p>How to use HTTP request: http:// SERVER_PATH ? iot_device_key = xxxxxx & parameter1 = value1 & parameterN = valueN</p>

	<p class="ml-5">- <b>iot_server:</b> IoT server address</p>

	<p class="ml-5">- <b>iot_device_key:</b> User IoT device key</p>

	<p class="ml-5">- <b>iot_sensor:</b> ID of sensor, this value get from IoT device setting, see it on ID column</p>

	<p class="ml-5">- <b>iot_sensor_value:</b> Value string of sensor, it like : KEYWORD1:VALUE1,KEYWORD2:VALUE2,...,KEYWORDn:VALUEn (Send parameter)</p>

	<p class="ml-5">- <b>iot_action:</b> IoT devices action, example ON or OFF a button. (return parameter)</p>

	<p><b>SERVER_PATH</b> to send value: http://tubestory.co.kr/iot/setval.do</p>

	<p><b>SERVER_PATH</b> to get action: http://tubestory.co.kr/iot/action.do</p> --%>

...
jLineBezier.prototype.draw = function() {
	...
	var startWid = 10-this.node1.getDepth()*2;
    var x1 = outputPort.x,
        y1 = outputPort.y - width/2 - startWid / 2,
        x4 = inputPort.x,
        y4 = inputPort.y,
		...
		y_width = y1+width+(startWid > 0 ? startWid : 0),
...
//	}
	...
	this.line.attr({"path": path, "stroke-width": width});

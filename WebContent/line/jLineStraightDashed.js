...
jLineStraightDashed = function (node1, node2){
	jLineStraightDashed.superclass.call(this, node1, node2);
}

extend(jLineStraightDashed, jLine);
jLineStraightDashed.prototype.type= "jLineStraightDashed";

jLineStraightDashed.prototype.draw = function() {
	...
	this.line.attr({path: path, "stroke-dasharray":"-"});

...
<html>
    <head>
	   ...
	   <link rel="shortcut icon" href="${pageContext.request.contextPath}/favicon.ico?v=<%=updateTime%>" />
        ...
        <!--폰트-->
        <link href='${pageContext.request.contextPath}/css/fonts/NotoSans.css' rel='stylesheet' type='text/css'>
		<link href="${pageContext.request.contextPath}/css/fonts/NanumGothic.css" rel="stylesheet">
		<link href='${pageContext.request.contextPath}/css/fonts/YanoneKaffeesatz.css' rel='stylesheet' type='text/css'>

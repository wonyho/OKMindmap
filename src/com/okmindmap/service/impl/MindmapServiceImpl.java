...
//	}
	...
	public int countMoodleMaps(int userId) {
		return this.mindmapDAO.countMoodleMaps(userId);
	}
	
	@Override
	public int countRemixMaps(int userId) {
		return this.mindmapDAO.countRemixMaps(userId);
	}
	
	@Override
	public int countIoTMaps(int userId) {
		return this.mindmapDAO.countIoTMaps(userId);
	}
	
	@Override
	public boolean canDeleteFileContent(String filePath, int mapId) {
		return this.mindmapDAO.canDeleteFileContent(filePath, mapId);
	}
	
	@Override
	public boolean canDeleteFileAttached(String filePath, int mapId) {
		return this.mindmapDAO.canDeleteFileAttached(filePath, mapId);
	}
	
	public List<Node> searchNodes(int mapId, String keyword, boolean hidden){
		return this.mindmapDAO.searchNodes(mapId, keyword, hidden);
	}
}

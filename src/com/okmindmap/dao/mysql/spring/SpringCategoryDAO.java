...
public class SpringCategoryDAO extends SpringDAOBase implements CategoryDAO {
	...
	public int insertCategory(String name, int parentid)
		...
		return getJdbcTemplate().queryForObject(sql, new Object[]{id, name, parentid}, Integer.class);
	}
	...
	public int moveCategory(int id, int newParentId)
		...
		return getJdbcTemplate().queryForObject(sql, new Object[]{id, newParentId}, Integer.class);
	}
	...
	public int swapCategory(int id1, int id2)
		...
		return getJdbcTemplate().queryForObject(sql, new Object[]{id1, id2}, Integer.class);
	}

...
public class NodeRowMapper extends RowMapperBase implements RowMapper {
	...
	public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		node.setFile( EscapeUnicode.text(rs.getString("file")));
		node.setNote( EscapeUnicode.text(rs.getString("note")));

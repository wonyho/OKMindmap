...
// Etc
	...
	public List<java.util.Map<String, Object>> getStatisticsByMonth(int userid);
	public List<java.util.Map<String, Object>> getStatisticsByMonth(int userid, Long createdFrom, Long createdTo);

...
//		logger = Logger.getLogger(ExportHTML.class); // wait for the upgrade to log4j 2.15.0
	}
    ...
    public void transform(Map map, Properties prop, OutputStream out) {
        ...
        try {
            ...
            if (!success) {
//            	logger.error("Error applying XSL template."); // wait for the upgrade to log4j 2.15.0

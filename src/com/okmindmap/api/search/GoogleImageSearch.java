...
public class GoogleImageSearch extends BaseAction {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String url = "https://www.googleapis.com/customsearch/v1?key=" + this.getActiveKey() + "&q=" + q
				+ "&searchType=image&num=9&start=" + start + "&cx=" + this.getSearchEngineID();
	...
	private String getActiveKey() {
		return SuperAdminManager.getActiveGoogleSearchKey(this.userService, "image");
	}
